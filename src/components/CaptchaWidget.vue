        ...
        <div v-if="!showChallenge && !verified" class="main-section">
          ...
          <div class="logo-area">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" class="logo-img">
              <defs>
                <linearGradient :id="`csGradient-${uid}`" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <rect width="120" height="120" fill="#f8fbff" :filter="`url(#shadow-${uid})`"/>
              
              <!-- Corner accent circles -->
              <circle cx="15" cy="15" r="8" :fill="`url(#csGradient-${uid})`" opacity="0.35"/>
              <circle cx="105" cy="105" r="8" :fill="`url(#csGradient-${uid})`" opacity="0.35"/>
              <circle cx="105" cy="15" r="5" :fill="`url(#csGradient-${uid})`" opacity="0.25"/>
              <circle cx="15" cy="105" r="5" :fill="`url(#csGradient-${uid})`" opacity="0.25"/>
              
              <!-- Decorative lines -->
              <line x1="20" y1="35" x2="40" y2="35" :stroke="`url(#csGradient-${uid})`" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
              <line x1="80" y1="35" x2="100" y2="35" :stroke="`url(#csGradient-${uid})`" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
              <line x1="20" y1="90" x2="40" y2="90" :stroke="`url(#csGradient-${uid})`" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
              <line x1="80" y1="90" x2="100" y2="90" :stroke="`url(#csGradient-${uid})`" stroke-width="2" stroke-linecap="round" opacity="0.6"/>
              
              <!-- Dots decoration -->
              <circle cx="50" cy="28" r="2" :fill="`url(#csGradient-${uid})`" opacity="0.7"/>
              <circle cx="70" cy="28" r="2" :fill="`url(#csGradient-${uid})`" opacity="0.7"/>
              <circle cx="50" cy="97" r="2" :fill="`url(#csGradient-${uid})`" opacity="0.7"/>
              <circle cx="70" cy="97" r="2" :fill="`url(#csGradient-${uid})`" opacity="0.7"/>
              
              <!-- Main text - CSAM -->
              <text x="60" y="75" font-size="30" font-weight="800" text-anchor="middle" :fill="`url(#csGradient-${uid})`" font-family="'Segoe UI', -apple-system, sans-serif" letter-spacing="1">CSAM</text>
              
              <!-- Bottom accent bar -->
              <rect x="30" y="85" width="60" height="3" :fill="`url(#csGradient-${uid})`" opacity="0.8" rx="1.5"/>
            </svg>
          </div>
        </div>
